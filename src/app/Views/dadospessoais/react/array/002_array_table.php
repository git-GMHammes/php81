    ...
    function App_table_array({ data }) {
        ...
        return (
            ...
            <div className="container mt-4">
                <h1>Table from ARRAY</h1>
                <h3>'http://localhost:4107/dadospessoais/array/exibir'</h3>
                <div>
                    <div className="d-flex justify-content-center">
                        # route GET /www/dadospessoais/endpoint/listar/array/(:any)
                    </div>
                    <div className="d-flex justify-content-center">
                        https://github.com/git-GMHammes/php81/blob/main/src/app/Views/dadospessoais/react/array/002_array_table.php
                    </div>
                </div>
                {/*
