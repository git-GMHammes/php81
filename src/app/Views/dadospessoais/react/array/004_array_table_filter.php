    ...
    function App_table_array_filter({ data }) {
        ...
        return (
            ...
            <div className="container mt-4">
                ...
                <h3>'http://localhost:4107/dadospessoais/endpoint/listar/array/filter'</h3>
                <div>
                    <div className="d-flex justify-content-center">
                        # route GET /www/dadospessoais/endpoint/listar/array/filter/(:any)
                    </div>
                    <div className="d-flex justify-content-center">
                        https://github.com/git-GMHammes/php81/blob/main/src/app/Views/dadospessoais/react/array/004_array_table_filter.php
                    </div>
                </div>
