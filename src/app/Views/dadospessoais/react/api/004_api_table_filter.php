<div id="reactResultApiTable"></div>
<script type="text/babel">
        ...
        return (
            <div className="container mt-4">
                ...
                <div>
                    ...
                    <div className="d-flex justify-content-center">
                        https://github.com/git-GMHammes/php81/blob/main/src/app/Views/dadospessoais/react/api/004_api_table_filter.php
                    </div>
                </div>
    ...
    ReactDOM.render(<AppTableApiFilter />, document.getElementById('reactResultApiTable'));
</script>