<?php
// www\qse\src\app\Views\icon\person_fill_dash.php
// Usuário com menos (-)
$height = (isset($height)) ? ($height) : ('16px');
$width = (isset($width)) ? ($width) : ('16px');
?>
<span>
    <svg xmlns="http://www.w3.org/2000/svg" width="<?= $width ?>" height="<?= $height ?>" fill="currentColor" class="bi bi-person-fill-dash" viewBox="0 0 16 16">
