<?php
// app\Views\icon\emoji_neutral_fill.php
$height = (isset($height)) ? ($height) : ('16px');
$width = (isset($width)) ? ($width) : ('16px');
?>
<span>
    <svg xmlns="http://www.w3.org/2000/svg" width="<?= $width ?>" height="<?= $height ?>" fill="currentColor" class="bi bi-emoji-neutral-fill" viewBox="0 0 16 16">
