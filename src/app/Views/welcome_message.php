        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-primary mb-2"
                            ...
                            target="_blanck">
                            React + Array Estático (ID)
                        </a>
                    </div>
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-success mb-2"
                            href="<?= base_url() . 'dadospessoais/endpoint/listar/array' . '/table'; ?>" role="button"
                            target="_blanck">
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-secondary mb-2"
                            href="<?= base_url() . 'dadospessoais/endpoint/listar/array' . '/paginator'; ?>"
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-danger mb-2"
                            href="<?= base_url() . 'dadospessoais/endpoint/listar/array' . '/filter'; ?>" role="button"
                            target="_blanck">
                            React + Array Estático (Tabela/Filtro)
                        </a>
                    </div>
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-warning mb-2"
                            href="<?= base_url() . 'dadospessoais/endpoint/create/dadospessoais'; ?>" role="button"
                            target="_blanck">
                            Formulário (Request/Loading/submit)
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-danger mb-2"
                            href="<?= base_url() . 'dadospessoais/endpoint/listar/api' . '/filter'; ?>" role="button"
                            target="_blanck">
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-warning mb-2"
                            href="<?= base_url() . 'dadospessoais/endpoint/listar/api' . '/all_in_one'; ?>"
                            role="button" target="_blanck">
            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-primary mb-2" href="<?= base_url() . 'calendar/endpoint/listar'; ?>"
                            role="button" target="_blanck">
                            Calendário
                        </a>
                    </div>
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-success mb-2"
                            href="<?= base_url() . 'calendar/endpoint/principal'; ?>" role="button" target="_blanck">
                            Principal
                        </a>
                    </div>
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-secondary mb-2" href="<?= base_url(); ?>" role="button"
                            target="_blanck">
                            secondary
                        </a>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-warning mb-2" href="<?= base_url(); ?>" role="button"
                            target="_blanck">
                            warning
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-primary mb-2" href="<?= base_url(); ?>" role="button"
                            target="_blanck">
                            primary
                        </a>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-outline-success mb-2" href="<?= base_url(); ?>" role="button"
                            target="_blanck">
                            success
                        </a>
                    </div>
