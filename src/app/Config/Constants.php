...
if (
    ...
    if (
        ...
        defined('GRUPO_DB_CONFIG') or define('GRUPO_DB_CONFIG', 'php81_dev');
    }
    ...
    if (
        ...
        defined('GRUPO_DB_CONFIG') or define('GRUPO_DB_CONFIG', 'habilidade02');
    }
} else {
    exit('src\app\Config\Constants.php, Erro de Banco');
}